...
export default function Navbar() {
  ...
  return (
    <nav
      ref={navRef}
      className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-8 py-4 bg-[#0a0a12]/70 backdrop-blur-md border-b border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.35)]"
      data-testid="navbar"
    >
      <a
        href="#home"
